...
const NavBar = () => {
    // TODO: Replace with your own Auth context when connecting the backend
    const session = { status: 'authenticated', data: { user: { name: 'Demo User', email: 'demo@example.com', id: '123' } } };
